package com.matthews.projetoCourse.config;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		User u3 = new User(null, "Maria Julia", "mariaJ@gmail.com", "989165489", "123789");
		...
		p1.getCategoryProduct().add(cat2);
		p2.getCategoryProduct().add(cat1);
		p2.getCategoryProduct().add(cat3);
		p3.getCategoryProduct().add(cat3);
		p4.getCategoryProduct().add(cat3);
		p5.getCategoryProduct().add(cat2);
		
		cat1.getListProduct().add(p2);
		cat2.getListProduct().add(p1);
		cat2.getListProduct().add(p5);
		cat3.getListProduct().add(p2);
		cat3.getListProduct().add(p3);
		cat3.getListProduct().add(p4);
